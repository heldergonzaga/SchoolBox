 ...
 */
@WebServlet("/FinanceiroController") 
public class FinanceiroController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private static String INSERE_OU_EDITE = "paginas/financeiro/addEdit.jsp";
    private static String LISTA_USUARIO = "paginas/financeiro/inicial.jsp";
